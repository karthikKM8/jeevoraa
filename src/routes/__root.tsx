...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Jeevora is a growth agency engineering hyper-growth through performance marketing, automation, and high-fidelity branding." },
      { property: "og:title", content: "Jeevora — Where Brands Become Market Leaders" },
      { property: "og:description", content: "Performance marketing, automation, and branding for ambitious companies." },
